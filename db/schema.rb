...
ActiveRecord::Schema.define(version: 2019_10_05_234315) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "accesstypes", force: :cascade do |t|
    t.string "accesstype"
  ...
  create_table "likesandpromotes", force: :cascade do |t|
  ...
  create_table "publicationtypes", force: :cascade do |t|
  ...
  create_table "userspublications", force: :cascade do |t|
    t.integer "user_id"
